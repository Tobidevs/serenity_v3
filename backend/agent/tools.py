...
def exa_search(main_query: str, guiding_query: str, domain_scope: list[str]):
    ...
    # The artifact carries the records to llm_node as structured data; the
    # content string is a fallback the model never normally sees, since
    # llm_node rewrites it with a favicon-free view.
    return records
